...
local function setup_lsp_mappings(args)
  ...
  lsp_nmap('<leader>gr', require('fzf-lua').lsp_references, '[G]oto [R]eferences')
  lsp_nmap('<leader>ds', require('fzf-lua').lsp_document_symbols, '[D]ocument [S]ymbols')
  lsp_nmap('<leader>ws', require('fzf-lua').lsp_live_workspace_symbols, '[W]orkspace [S]ymbols')
  lsp_nmap('<leader>oc', require('fzf-lua').lsp_outgoing_calls, '[O]utgoing [C]alls')
  lsp_nmap('<leader>ic', require('fzf-lua').lsp_incoming_calls, '[I]ncoming [C]alls')
